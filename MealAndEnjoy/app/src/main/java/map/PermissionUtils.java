...
public class PermissionUtils {
    ...
    public static void requestPermission(final Activity activity,final int requestCode,PermissionGrant permissionGrant){
        ...
        Log.i(TAG,"请求权限 请求代码:"+requestCode);
        if(requestCode < 0 || requestCode >= requestPermissions.length){
            Log.w(TAG,"请求权限不合法 请求代码:"+requestCode);
            return;
        }
...
//        }
    ...
    private static void requestMultiResult(Activity activity,String[] permissions,int[] grantResults,PermissionGrant permissionGrant){
        ...
        //TODO
        Log.d(TAG,"请求权限结果 permissions length:"+permissions.length);
        ...
        if(notGranted.size() == 0){
            Toast.makeText(activity,"成功获取全部权限"+notGranted,Toast.LENGTH_SHORT).show();
            permissionGrant.onPermissionGranted(CODE_MULTI_PERMISSION);
        }else{
            openSettingActivity(activity,"这些权限需要获取");
        }
    }
    ...
    public static void requestMultiPermissions(final Activity activity,PermissionGrant grant) {
        ...
        if(permissionsList.size() > 0){
            ...
            showMessageOKCancel(activity,"应该打开这些权限",new DialogInterface.OnClickListener(){
                @Override
    ...
    public static void requestPermissionsResult(final Activity activity,final int requestCode,
        ...
        Log.d(TAG,"请求权限结果 请求代码:"+requestCode);
        ...
        if(requestCode < 0 || requestCode >= requestPermissions.length){
            Log.w(TAG,"请求权限结果不合法 请求代码:"+requestCode);
            Toast.makeText(activity,"不合法 请求代码:"+requestCode,Toast.LENGTH_SHORT).show();
            return;
        }

        Log.i(TAG,"onRequestPermissionsResult requestCode:"+requestCode+",permissions:"+
                permissions.toString()+",grantResults:"+grantResults.toString()+",length:"+grantResults.length);
        if(grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            Log.i(TAG,"onRequestPermissionsResult PERMISSION_GRANTED");
            //TODO success,do something, can user callback
            permissionGrant.onPermissionGranted(requestCode);
        }else{
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity,boolean isShouldRationale){
        ...
        for (int i = 0;i < requestPermissions.length;i++){
            ...
            try {
                ...
                Toast.makeText(activity,"请打开这些权限",Toast.LENGTH_SHORT).show();
                Log.e(TAG,"RuntimeException:"+e.getMessage());
                return null;
            }

            if (checkSelfPermission != PackageManager.PERMISSION_GRANTED){
                Log.i(TAG, "getNoGrantedPermission ActivityCompat.checkSelfPermission != PackageManager.PERMISSION_GRANTED:" +
                        requestPermission);
                if(ActivityCompat.shouldShowRequestPermissionRationale(activity,requestPermission)){
